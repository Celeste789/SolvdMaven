...
public class Developer extends Employee {
    ...
    public Developer(int antiquity, String name, int id, String githubLink) throws NegativeAntiquityException, NotClientNorEmployeeException {
        super(antiquity, name, id, "Developers", basicSalary);
